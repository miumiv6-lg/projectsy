...
import { ArrowLeft, Check, Star, Zap, Crown, ChevronDown, ChevronUp } from 'lucide-react';
              ...
              >
                ...
                <div className={`overflow-hidden transition-all duration-300 ${isExpanded ? 'max-h-[300px] opacity-100' : 'max-h-0 opacity-0'}`}>
                  <div className="px-4 pb-4 pt-0 border-t border-[#2d313a] mt-2">
                    ...
                    <button className={`w-full py-2.5 rounded-lg text-sm font-bold text-white transition-colors ${btnClasses}`}>
                      Выбрать
                    </button>
                  </div>
                </div>
